...
public class BSTree<E extends Comparable<E>> extends Tree<E> implements BSTreeIF<E> {
	...
	public int calculateHeight() {
		...
		throw new UnsupportedOperationException("Unimplemented method 'calculateHeight'");
	}

	@Override
	public int calculateFanOut() {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'calculateFanOut'");
	}
